...
/***/ function(module, exports, __webpack_require__) {
	...
	var _audio_player = __webpack_require__(89);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var BEATS_PER_MINUTE = [null, 30, 40, 50, 60, 70, 80, 90, 100, 120];

	var blub = function blub() {
	  var bla = "adfsd";
	};

	var Metronome = exports.Metronome = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      "div",
	      null,
	      _react2.default.createElement(_audio_player.AudioPlayer, { bpm: this.state.bpm }),
	      _react2.default.createElement("input", { type: "text", onChange: this.setMetronome }),
	      BEATS_PER_MINUTE.map(function (bpm) {
	        var beat = bpm ? bpm : "reset";
	        return _react2.default.createElement(
	          "div",
	          null,
	          _react2.default.createElement(
	            "button",
	            { value: beat, onClick: _this.setMetronome },
	            beat
	          )
	        );
	      })
	  ...
	  setMetronome: function setMetronome() {
	    var event = arguments[0];
	    var value = isNaN(event.target.value) ? null : parseFloat(event.target.value);
	    var millis = Math.round(60 / value * 1000);
...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_index.Metronome, null), document.getElementById('container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AudioPlayer = exports.AudioPlayer = function (_React$Component) {
	  ...
	  _createClass(AudioPlayer, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        "audio",
	        { controls: true },
	        _react2.default.createElement("source", { src: "sidestick01.ogg", type: "audio/ogg" }),
	...
	/* export var AudioPlayer = React.createClass({
	   render: function(){
